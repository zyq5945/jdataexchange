        ...
        return (
            <table style={{ border: 1 }} cellSpacing="0">
                ...
                <tr>
                    <td>
                        <form ref="myform">
                            Hidden: <input name="_csrf" type="hidden" defaultValue=""/> <br/>
                            Name: <input name="name" type="text" defaultValue="" /> <br/>
                            Password: <input name="password" type="password" defaultValue="" /> <br/>
                            Sex: <input name="sex" type="radio" value="Male" defaultChecked="checked"/>
